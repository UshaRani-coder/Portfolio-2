...
function Navbar(props) {
  ...
  return (
    ...
    <div className="flex w-[100%] justify-between text-black p-[10px] bg-[#D80065] ">
      {/* <img src={logoDarkMode} alt="logo" width={'70px'} className=" animate-logo" /> */}
      <span className='logo animate-logo'>UR</span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={'20px'}  className="animate-hamburger cursor-pointer" onClick={props.handleClick}>
