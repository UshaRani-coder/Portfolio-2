...
function Hero() {
  return (
    <div className='p-[10px] flex flex-col-reverse pt-[50px]  items-center'>
      <div className='animate-content  flex flex-col items-center pt-[20px]'>
        <h1 className='  w-[230px] py-[10px] px-[5px] rounded-2xl  flex gap-[5px]'> Namaskar<img src={gif} width={'20px'}/>  , I'm <span className='text-[rgb(188,63,255)] name'>Usha Rani!</span></h1>
        <span className='role text-[rgb(188,63,255)] text-3xl'> A Frontend Developer.</span>
