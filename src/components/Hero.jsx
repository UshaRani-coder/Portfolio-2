...
function Hero() {
  return (
    <div
      className='p-[10px] flex flex-col-reverse lg:flex-row-reverse lg:justify-center lg:items-center xl:gap-[50px] pt-[50px] md:pt-[60px]  items-center text-[rgb(181,187,198)]'
      id='about'
    >
      <div className='animate-content  flex flex-col items-center pt-[20px] lg:pt-0'>
        ...
        <p className='ml-[25px] text-xl sm:m-[0px] md:mt-[10px] md:tracking-wider text-white'>
        ...
        <div className='socials flex gap-[20px] my-[10px] mt-[20px]'>
          <Link to='tel:8465842779'>
            <img
              ...
              alt=''
              width={'20px'}
              className='cursor-pointer phone '
            />
          </Link>
          <Link to='mailto:ur66026@gmail.com'>
            <img
              ...
              alt='Gmail'
              width={'20px'}
              className='cursor-pointer gmail '
            />
          </Link>
          <Link to='https://www.linkedin.com/in/usha-rani-207939245/'>
            <img
              ...
              alt=''
              width={'20px'}
              className='cursor-pointer linkedin '
            />
          </Link>
  ...
  <img src={ushaRaniImg} alt="person" className='animate-img-fall rounded-full w-[100px] lg:w-[200px]' />
      ...
      <div id='my-img'>
        <img
          src={ushaRaniImg}
          alt='person'
          className='animate-img-fall rounded-full w-[100px] lg:w-[200px]'
        />
      </div>
    </div>
  )
