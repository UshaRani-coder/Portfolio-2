...
function App() {
  ...
  return (
    <div className="bg-[#000000] text-white ">
      ...
      {toggle && 
      <ul className={`animate-hamburgerMenu ${toggle ? '' : 'hide'} w-[100%] h-screen absolute top-[0px] bottom-0  z-50 bg-[#1a1a1a] flex flex-col px-[60px] py-[40px] pt-[100px] gap-y-[10px] items-center cursor-pointer`} >
      ...
      {toggle ? (
        ...
        >
          <li className="section" onClick={()=><Home />}>Home</li>
          <li className="section">About</li>
          <li className="section">Work</li>
          <li className="section">Skills</li>
          <li className="section">Projects</li>
