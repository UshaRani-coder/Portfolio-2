...
//   return (
//     <div style={{ position: 'fixed', top: '0', left: '0',right: '0',zIndex:'0', width: 'full', height: '100%', pointerEvents: 'none' }}>
//       {stars.map((star) => (
//         <motion.div
//           key={star.id}
...
function AnimatedBackground(){
  ...
  return (
    <div style={{ position: 'fixed', top: '0', left: '0',right: '0',zIndex:'0', width: '100vw', height: '100vh', pointerEvents: 'none' }}>
      {stars.map((star) => (
        <motion.div
          key={star.id}
          initial={{ opacity: 0, y: star.y, x: star.x }}
